...
public class Student {
    ...
    public void addGrade(int courseCredits, double grade) {
        ...
        double addedQualityScore = courseCredits * grade;
        this.setNumberOfCredits(this.getNumberOfCredits() + courseCredits);
        // sets new GPA by adding the quality score of the parameters to the totalQualityScore and then deviding that by the new number of credits to calculate a new overall GPA.
        this.setGpa((totalQualityScore + addedQualityScore) / (this.getNumberOfCredits() + courseCredits));
    }
